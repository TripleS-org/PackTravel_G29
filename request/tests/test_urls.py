...
class TestUrl(SimpleTestCase):
    ...
    def test_requested_ride_resolves(self):
        ...
        self.assertEqual(resolve(url).func, requested_rides) # pylint: disable=deprecated-method
    ...
    def test_cancel_ride_resolves(self):
        ...
        self.assertEqual(resolve(url).func, cancel_ride) # pylint: disable=deprecated-method
    ...
    def test_cancel_accepted_ride_resolves(self):
        ...
        self.assertEqual(resolve(url).func, cancel_accepted_ride) # pylint: disable=deprecated-method
    ...
    def test_accept_request_resolves(self):
        ...
        self.assertEqual(resolve(url).func, accept_request) # pylint: disable=deprecated-method
    ...
    def test_reject_request_resolves(self):
        ...
        self.assertEqual(resolve(url).func, reject_request) # pylint: disable=deprecated-method
    ...
    def test_delete_ride_resolves(self):
        ...
        self.assertEqual(resolve(url).func, delete_ride) # pylint: disable=deprecated-method
